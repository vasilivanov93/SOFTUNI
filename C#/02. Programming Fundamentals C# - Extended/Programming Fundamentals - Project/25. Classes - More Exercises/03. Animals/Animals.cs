       ...
       public static void Main()
        {
                ...
                if (inputLine.Length > 2)
                {
                    ...
                    switch (type)
                    {
                        ...
                        case "Snake":
                            ...
                            newSnakes.Name = name;
                            newSnakes.Age = age;
                            newSnakes.CrueltyCoefficient = parameter;

                            snakes.Add(newSnakes.Name, newSnakes);
                            break;
                    }
                }
                else
            ...
            {
                Console.WriteLine($"Dog: {cat.Name}, Age: {cat.Age}, IQ: {cat.IntelligenceQuotient}");
            }

            foreach (var snake in snakes.Values)
            {
                Console.WriteLine($"Dog: {snake.Name}, Age: {snake.Age}, Cruelty: {snake.CrueltyCoefficient}");
            }
        }
    }
}